...
export default async function AdminContentPage() {
  ...
  return (
    <div className={styles.dashboard}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: '2rem', alignItems: 'start' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <div className={styles.card}>
            ...
            <form action={saveContentBlock} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
              <div>
              ...
              <tbody>
                {giftCards.map((card) => (
                  <tr key={card.id}>
                    ...
                    <td>{card.currentBalance} / {card.initialBalance} MAD</td>
                    <td>{card.isActive ? 'Active' : 'Disabled'}</td>
                  </tr>
                ))}
                {giftCards.length === 0 && (
                  <tr>
